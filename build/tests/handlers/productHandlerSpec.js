...
describe('Product Handler', function () {
    var productId;
    it('Should create or add a new product', function () { return __awaiter(void 0, void 0, void 0, function () {
        var response, _a, id, result;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    response = _b.sent();
                    _a = response.body, id = _a.id, result = __rest(_a, ["id"]);
                    productId = id;
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    result.body.forEach(function (product) {
                        var id = product.id, productData = __rest(product, ["id"]);
    ...
    it('Should return the correct product', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, request.get("/products/".concat(productId))];
                case 1:
                    result = _a.sent();
