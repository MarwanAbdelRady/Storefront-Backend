...
var ps = new product_1.ProductStore();
...
describe('Product Model', function () {
    ...
    it('create method should add a product', function () { return __awaiter(void 0, void 0, void 0, function () {
        var response, i, _a, id, productData;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, ps.create('alpha', 100)];
                case 2:
                    response = _b.sent();
                    _b.label = 3;
                case 3:
                    ...
                    return [3 /*break*/, 1];
                case 4:
                    _a = response, id = _a.id, productData = __rest(_a, ["id"]);
    ...
    it('index method should return a list of products', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, ps.index()];
                case 1:
                    result = _a.sent();
                    result.forEach(function (newProduct) {
                        var id = newProduct.id, productData = __rest(newProduct, ["id"]);
    ...
    it('show method should return the correct product', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, ps.show(1)];
                case 1:
                    result = _a.sent();
