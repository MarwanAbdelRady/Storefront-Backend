    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                validJwt = jsonwebtoken_1.default.verify(token, secret);
                if (!validJwt) {
                    throw new Error();
                }
                decoded = jsonwebtoken_1.default.decode(token);
                return [4 /*yield*/, user.show(decoded.us.id)];
            case 1:
                user1 = _a.sent();
                if (!user1)
                    throw new Error();
